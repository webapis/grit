...
class HomeComponent extends React.Component {
 ...
 //.filter(f=> f.count !==undefined)
    render() {
        const {categories,placeholder,role,gender}=this.props
        ...
        return <div>
            <ResponsiveComponent maxWidth={800} render={()=><DrawerMobile gender={gender} categories={mapped} ><Categories gender={gender} categories={mapped} placeholder={placeholder}/></DrawerMobile>} />
            <ResponsiveComponent minWidth={801} render={()=><DrawerDesktop gender={gender} categories={mapped}><Categories gender={gender} categories={mapped} placeholder={placeholder}/></DrawerDesktop>} />
        </div>
    }
}
