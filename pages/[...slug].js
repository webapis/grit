...
function TestPage(props) {
    const {navKeywords,products,categories,functionName,keywordgroup} =props
    ...
    // console.log('props.....', props)
        ...
        return <Products  keywordgroup={keywordgroup} navKeywords={navKeywords} products={products} categories={categories} functionName={functionName}/>
...
export async function getStaticProps(context) {
    ...
    return {
        props: {navKeywords,products,categories,functionName,keywordgroup}, // will be passed to the page component as props
        revalidate: 10
    }
}
